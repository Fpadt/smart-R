...
# ==============================================================================
# 01-SYSTEM-HARDENING MODULE SETUP SCRIPT
# ==============================================================================
...
# Main setup function
main() {
    log_section "🚀 01-SYSTEM-HARDENING Module Setup Starting"
    ...
    if [[ ${#failed_scripts[@]} -eq 0 ]]; then
        ...
        log_info "🚀 01-SYSTEM-HARDENING module is now configured"
    else
...
case "${1:-}" in
    -h|--help)
        echo "01-SYSTEM-HARDENING Module Setup Script"
