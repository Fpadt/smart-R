...
# ==============================================================================
# 02-CONTAINER-RUNTIME MODULE SETUP SCRIPT
# ==============================================================================
...
# Main setup function
main() {
    log_section "🚀 02-CONTAINER-RUNTIME Module Setup Starting"
    ...
    if [[ ${#failed_scripts[@]} -eq 0 ]]; then
        ...
        log_info "🚀 02-CONTAINER-RUNTIME module is now configured"
    else
...
case "${1:-}" in
    -h|--help)
        echo "02-CONTAINER-RUNTIME Module Setup Script"
