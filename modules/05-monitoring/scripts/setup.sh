...
# ==============================================================================
# 05-MONITORING MODULE SETUP SCRIPT
# ==============================================================================
...
# Main setup function
main() {
    log_section "🚀 05-MONITORING Module Setup Starting"
    ...
    if [[ ${#failed_scripts[@]} -eq 0 ]]; then
        ...
        log_info "🚀 05-MONITORING module is now configured"
    else
...
case "${1:-}" in
    -h|--help)
        echo "05-MONITORING Module Setup Script"
